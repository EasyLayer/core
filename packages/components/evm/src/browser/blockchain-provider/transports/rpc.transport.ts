...
export interface BrowserRpcTransportOptions {
  uniqName: string;
  httpUrl: string;
...
export class BrowserRpcTransport extends BaseTransport {
  public readonly type = 'browser-rpc' as const;
  ...
  constructor(options: BrowserRpcTransportOptions) {
    super();
